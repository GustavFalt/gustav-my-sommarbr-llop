import { Car, Phone, Mic, Heart } from "lucide-react";

const PracticalInfoSection = () => {
  const sections = [
    {
      icon: Heart,
      title: "Barn på bröllopet",
      content: (
    ...
    },
    {
      ...
      content: (
        <p className="text-sm text-muted-foreground font-light leading-relaxed whitespace-pre-line">
          {"Parkering vid Gamla Uppsala kyrka finns i anslutning till Gamla Uppsala högar eller vid Odinsborg.\n\nVid Restaurang Ulva finns möjlighet att parkera på markerade platser. På gräsplanen väster om restaurangen finns det gott om plats."}
        </p>
      ),
    },
    {
  ...
  return (
    <section className="py-16 md:py-32 px-6 bg-secondary">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="mt-10 md:mt-12 grid sm:grid-cols-2 gap-10 md:gap-14 text-left">
